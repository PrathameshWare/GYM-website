          ...
          <div className="mt-[10rem]">
            <div className="grid grid-cols-2 grid-rows-2 w-full min620:grid-cols-1">
              <div className="w-full bg-white h-[43rem] flex flex-col justify-center items-center text-center px-[100px] min800:px-[10px]">
                ...
                <h2 className="text-[36px] font-bold mt-3">Our Achievement</h2>
                <p className="text-[16px] font-medium text-[#646464] mt-5">
                Available in all city across the world with best equipment.
                </p>
              </div>
              {/*  */}
              ...
              <div className="w-full bg-white h-[43rem] flex flex-col justify-center items-center text-center px-[100px] min800:px-[10px]">
                ...
                <p className="text-[16px] font-medium text-[#646464] mt-5">
                They are very soft and don't leave anywhere there is any pain. He wants the services of the home, for he wants to soften the exercise.
                </p>
              </div>
            </div>
          </div>
