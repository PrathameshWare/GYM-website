  ...
  return (
    <>
      <section>
        ...
        <div className="bg-white py-[12rem] page-padding grid grid-cols-2 container gap-10 items-center md1000:grid-cols-1 ">
          ...
          <div className="md1000:w-[60%] md1000:flex md1000:flex-col md1000:mx-auto min800:w-[90%] min620:w-full">
            ...
            <p className="text-[16px] w-[95%] text-[#646464] font-medium my-[40px]">
              At V-gym, we are dedicated to helping you achieve the body of
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-y-20 min620:grid-cols-1 min620:mx-auto">
              <div className="flex flex-col relative">
                ...
                <p className="text-[15px] font-medium text-[#646464]">
                  Near Vidyalankar Institute of technology  
                  <br /> Maharashtra , Mumbai 400037
                </p>
              </div>
              {/*  */}
              <div className="flex flex-col relative">
        ...
        {/* map */}
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d377150.85471581115!2d72.74109781748556!3d18.96697998311503!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7ce3194d6c3bd%3A0x2736db16e66f9f4e!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1634074809293!5m2!1sen!2sin"
          allowFullScreen=""
          loading="lazy"
          samesite="Strict"
          title="map"
